	        ...
	        <div id="containerIn">
	            ...
	            <div class="board">
	                <ul>
	                    ...
	                    <li>
	                        <p class="gong">공지</p>
	                        <p class="title"><a href="/board/boardDetail">[결제] -Parameter가 정상적이지 않습니다 - 확인 시 조치방법 안내 (패치완료)</a></p>
	                    ...
	                    <li>
	                        <p class="gong">공지</p>
	                        <p class="title"><a href="/board/boardDetail">COVID-19 예방을 위한 캣드림의 체계적인 방역 관리 솔루션!</a></p>
	                        <p class="user">CatDream</p>
	                    ...
	                    <li>
	                        <p class="num">1</p>
	                        <p class="title"><a href="/board/boardDetail">10월 대체공휴일 지정에 따른 출고 및 배송일정 안내</a></p>
	                        <p class="user">CatDream</p>
	                    ...
	                    <li>
	                        <p class="num">2</p>
	                        <p class="title"><a href="/board/boardDetail">[이벤트 종료]5만원 이상 구매시, 10,000원 상당 영양제 무료 증정!</a></p>
	                        <p class="user">CatDream</p>
